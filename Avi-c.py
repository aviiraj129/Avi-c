...
\033[1;37;1m  
  ...
  ______   __     __  ______        _______    ______      _____ 
 /      \ /  |   /  |/      |      /       \  /      \    /     |
/$$$$$$  |$$ |   $$ |$$$$$$/       $$$$$$$  |/$$$$$$  |   $$$$$ |
$$ |__$$ |$$ |   $$ |  $$ |        $$ |__$$ |$$ |__$$ |      $$ |
$$    $$ |$$  \ /$$/   $$ |        $$    $$< $$    $$ | __   $$ |
...
\033[1;37;1m-----------------------------------------------
\033[1;37;1m  Author   : BR9HM9N B0II AVI
033[1;37;1m  Facebook : https://www.facebook.com/profile.php?id=avi.love.arfa
\033[1;37;1m  Virson   : 2024 [[ PAID TOOL  KE LIYE CONTACT ON  NICHE NUMBER] ] 
\033[1;371m whatsapp [+91 8340514701]
\033[1;37;1m-----------------------------------------------"""
...
def sendtextconvo(comment):
    try:
        ...
        print("Apka Id inbox se block ya Grurop se bahar nikal diya hai ya fir browser par id opne kar ke aproble deyn❤️")
        exit(1)
    try:
